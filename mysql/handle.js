...
var userData = {
    add: function(req, res, next) {
        pool.getConnection(function(err, connection) {
            ...
            connection.query(sql.insert, [param.id, param.username, param.age], function(err, result) {
                if (result) {
                    result = 'add'
                }
    ...
    update: function(req, res, next) {
        ...
        if (param.username == null || param.age == null || param.id == null) {
            json(res, undefined);
            return;
        }
        pool.getConnection(function(err, connection) {
            connection.query(sql.update, [param.username, param.age, +param.id], function(err, result) {
                console.log(err,'err');
